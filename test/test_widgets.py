...
def test_daterange_single():

    app = QgsApplication([], False)
    from datacube_query.ui import widgets

    test_data = ['2001-01-01']
...
def test_daterange_single_none():

    app = QgsApplication([], False)
    from datacube_query.ui import widgets

    test_data = ['2001-01-01', None]
...
def test_products():
    ...
    test_data = OrderedDict([
        ['ls5_nbar_albers', ['blue', 'green', 'red', 'nir', 'swir1', 'swir2']],
